...
import com.example.earthquakecopy.list;
...
public final class query{
     ...
     */
    public static ArrayList<list> extractEarthquakes() {

        // Create an empty ArrayList that we can start adding earthquakes to
        ArrayList<list> earthquakes = new ArrayList<>();
        ...
        try {
            ...
            JSONObject EarthQuakeProperties = features.getJSONObject(i);
            JSONObject properties = EarthQuakeProperties.getJSONObject("properties");
            Double  magnitude = properties.getDouble("mag");
            String place = properties.getString("place");
            String url = properties.getString("url");
//            String times = properties.getString("time");
            long times = properties.getLong("time");
            list earthQuakeDetails = new list(magnitude,place,times,url);
